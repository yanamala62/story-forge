...
export type AnyJobData = EpisodePipelineJobData | StoryGenerationJobData | SceneGenerationJobData | PromptGenerationJobData | ImageGenerationJobData | NarrationJobData | SubtitleJobData | VideoCompositionJobData | SeoGenerationJobData | UploadJobData | AnalyticsCollectionJobData;
